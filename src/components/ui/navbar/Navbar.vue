...
<template>
  <nav class="flex items-center justify-between py-4 px-6 border-b bg-background">
    ...
    <div class="flex items-center space-x-2">
      ...
      <Button as-child variant="outline" size="icon" aria-label="Toggle theme">
        <a href="https://github.com/riceball-tw/auto-form-vue">
            <span class="sr-only">GitHub Repo Link</span>
